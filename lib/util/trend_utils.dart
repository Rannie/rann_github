...
class GitHubTrending {
  fetchTrending(url) async {
    var res = await HttpManager.instance.get(url, null, Options(contentType: ContentType.text));
    if (res != null && res.result && res.data != null) {
      return ResultData(TrendingUtils.htmlToRepo(res.data), true, Code.SUCCESS);
    } else {
      return res;
    }
  }
